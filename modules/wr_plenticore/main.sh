...
if [[ $speichermodul == "speicher_kostalplenticore" ]]; then
	python /var/www/html/openWB/modules/wr_plenticore/read_kostalplenticore.py $kostalplenticoreip $kostalplenticoreip2 1 $kostalplenticoreip3
else
	python /var/www/html/openWB/modules/wr_plenticore/read_kostalplenticore.py $kostalplenticoreip $kostalplenticoreip2 0 $kostalplenticoreip3
fi
