...
then
	...
	then
		...
		socat pty,link=$fsm63a3llsource,raw tcp:$fsm63a3modbuslllanip:26 &
	fi
else
	echo "echo" > /dev/null
fi
...
python /var/www/html/openWB/modules/fsm63a3modbusll/readfsm63a3.py $fsm63a3modbusllsource $fsm63a3modbusllid $ramdiskpath
